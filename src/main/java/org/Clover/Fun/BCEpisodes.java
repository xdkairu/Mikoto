...
public class BCEpisodes extends ListenerAdapter {
    ...
    private static final String MESSAGE = "**Title**: `%s`\n**Episode**: `%s`\n**Duration**: `%s`\n**Link**: [CrunchyRoll](%s \"Black Clover Episode Link\")";
    ...
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        ...
        try {
            ...
            eb.setDescription("`" + event.getOption("episode").getAsString() + "` is not an episode from Black Clover");
        ...
        embed.setDescription(String.format(MESSAGE, episode.name(), number, "23:53", episode.url()));
